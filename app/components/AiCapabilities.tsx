    ...
    <div className="space-y-6 mt-12 animate-fade-in" style={{ animationDelay: '400ms' }}>
      ...
      <div className="grid grid-cols-1 gap-4">
        {capabilities.map((cap, i) => (
          <div 
            key={i} 
            className="group flex gap-4 p-3 rounded-xl hover:bg-surface-900/40 transition-colors border border-transparent hover:border-surface-800"
          >
            ...
            <div>
              <h4 className="text-sm font-medium text-surface-200 group-hover:text-white pb-0.5">
                {cap.title}
              </h4>
